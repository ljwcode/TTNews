...
@interface QRCodeManager()<AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureMetadataOutputObjectsDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIGestureRecognizerDelegate, QRCodePreviewVIewDelegate>
...
- (instancetype)initWithPreviewView:(QRCodePreviewVIew *)previewView completion:(nonnull void (^)(void))completion {
    if (self = [super init]) {
        if ([previewView isKindOfClass:[QRCodePreviewVIew class]]) {
            _previewView = (QRCodePreviewVIew *)previewView;
...
#pragma mark - QRCodePreviewVIewDelegate
