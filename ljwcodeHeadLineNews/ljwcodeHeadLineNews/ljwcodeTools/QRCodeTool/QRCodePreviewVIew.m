...
@implementation QRCodePreviewVIew

- (instancetype)initWithFrame:(CGRect)frame {
    return [[QRCodePreviewVIew alloc] initWithFrame:frame rectFrame:CGRectZero rectColor:[UIColor clearColor]];
}

- (instancetype)initWithFrame:(CGRect)frame rectColor:(UIColor *)rectColor {
    return [[QRCodePreviewVIew alloc] initWithFrame:frame rectFrame:CGRectZero rectColor:rectColor];
}

- (instancetype)initWithFrame:(CGRect)frame rectFrame:(CGRect)rectFrame {
    return [[QRCodePreviewVIew alloc] initWithFrame:frame rectFrame:rectFrame rectColor:[UIColor clearColor]];
}
...
- (void)torchSwitchClicked:(UIButton *)button {
    if ([self.delegate respondsToSelector:@selector(codeScanningView:didClickedTorchSwitch:)]){
        [self.delegate codeScanningView:self didClickedTorchSwitch:button];
    }
}
/*
