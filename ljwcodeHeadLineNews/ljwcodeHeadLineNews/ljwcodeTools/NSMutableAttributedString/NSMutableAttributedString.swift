...
//  ljwcodeHeadLineNews
//
//  Created by ljwcode on 2022/3/2.
...
extension NSMutableAttributedString {
    static func highLightText(_ normal: String, highLight: String, font: UIFont, color: UIColor, highLightColor: UIColor) -> NSMutableAttributedString {
        ...
        for i in 0..<strings.count {
            let item = strings[i]
            let dict = [NSMutableAttributedString.Key.font : font,
            ...
            if i != strings.count - 1 {
                let dict1 = [NSMutableAttributedString.Key.font : font,
                             NSMutableAttributedString.Key.foregroundColor : highLightColor]
